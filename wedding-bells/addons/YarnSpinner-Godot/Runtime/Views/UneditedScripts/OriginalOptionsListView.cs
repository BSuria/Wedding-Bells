...
namespace YarnSpinnerGodot
{
    ...
    public partial class OptionsListView : Node, DialogueViewBase
    {
        ...
        [Export] DialogueOptionsPreview optionsText;
        [Export] public RichTextLabel lastLineCharacterNameText;
        [Export] public RichTextLabel lastLineText;
        [Export] public RichTextLabel OptionPreviewText;

        /// <summary>
        /// A signal that is emitted before the options have been processed and after
        /// there is text in the lastlineseen
        /// </summary>
        [Signal]
        public delegate void onOptionSelectBeginEventHandler();
        ...
        public string SpeakingCharacter
        {
            get
            {
                if (lastSeenLine != null && lastSeenLine.CharacterName != null)
                {
                    return lastSeenLine.CharacterName;
                }
        ...
        {
            GD.Print("RunOptionsInternal ran");
            try
            {
                ...
                EmitSignal(SignalName.onOptionSelectBegin);
